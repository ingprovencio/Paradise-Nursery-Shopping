...
function ProductList({ onHomeClick }) {
    ...
    const returnBrCart = (props) => {
        console.log('returnBrCart')
        if (cart.items.filter(item => item.name !== props.name)) {
            return (
                <button className="product-button" disabled onClick={() => handleAddToCart(plant)}>Add to Cart</button>
            );
        }
        else {
            return (
